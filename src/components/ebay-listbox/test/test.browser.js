    ...
    describe('when the down arrow key is pressed', () => {
        ...
        describe('when the up arrow key is pressed', () => {
            ...
            it('then it emits the change event with the correct data', () => {
                ...
                expect(changeEvent).has.property('selected').and.is.deep.equal([options[0].value]);
            });
        });
    });
});
...
describe('given the listbox with manual selection', () => {
    beforeEach(async () => {
        component = await render(Standard, { options, name: 'listbox-name' }, { container: form });
    });
...
describe('given the listbox with disabled option', () => {
    beforeEach(async () => {
        ...
        component = await render(Standard, { options, container: form, name: 'listbox-name' });
    });
