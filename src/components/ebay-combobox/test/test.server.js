...
describe('combobox', () => {
    it('renders basic version', async () => {
        ...
        expect(getByRole('combobox').parentElement).does.not.have.class(
            'combobox_control--borderless'
        );
        expect(getByRole('listbox')).has.class('combobox_listbox');
    ...
    it('renders with borderless enabled', async () => {
        ...
        expect(getByRole('combobox').parentElement).has.class('combobox_control--borderless');
    });
...
testEventsMigrator(
    require('../migrator'),
    'combobox',
    [{ from: 'input', to: 'input-change' }, 'collapse', 'change', 'select', 'expand'],
    '../index.marko'
);
