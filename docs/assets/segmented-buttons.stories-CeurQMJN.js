import{t as Z}from"./index-CCz6reEH.js";import{b as F,a as G}from"./utils-DWCsNc5l.js";import{t as z,r as q,b as W,e as k,f as x,p as v,d as M}from"./registry-B-klnak9.js";import{_ as m}from"./dynamic-tag-DQCvkDdb.js";import{_ as J,a as K}from"./index-BD-Pnzly.js";import{_ as d}from"./render-tag-BBOJ9dEX.js";import{i as b,r as B,a as I}from"./attr-tag-DphMQldM.js";import{_ as L}from"./empty-component-BCB5DEsP.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-Bd083XES.js";/* empty css             */class N extends Marko.Component{onCreate(){this.state={selectedIndex:0}}onInput(e){let t=(e.buttons||[]).findIndex(n=>n.selected);t===-1&&(t=0),this.state.selectedIndex=t}onButtonClick(e,t){e!==this.state.selectedIndex&&(this.state.selectedIndex=e,this.emit("change",{index:e,value:(this.input.buttons[e]||{}).value||void 0,originalEvent:t}))}}const p="PEDetnqc",l=z(p),O=l,U=["large"];q.r(p,()=>l);const Q=N;l._=W(function(s,e,t,n,y,D){let{size:o,class:te,buttons:ne,...R}=s;var h=o&&U.includes(o)?o:null;e.be("div",k({class:x(["segmented-buttons",h&&`segmented-buttons--${h}`,s.class])},v(R)),"0",n,null,4),e.be("ul",null,"1",n,null,0);{let j=0;for(const _ of s.buttons||[]){let c=j++;const a=`[${c}]`,{class:V,icon:f,renderBody:H,...P}=_;e.be("li",null,"2"+a,n,null,0),e.be("button",k({class:x(["segmented-buttons__button",V]),"aria-current":y.selectedIndex===c&&"true"},v(P)),"3"+a,n,null,4,{onclick:t.d("click","onButtonClick",!1,[c])}),f?(e.be("span",{class:"segmented-buttons__button-cell"},"4"+a,n,null,1),m(e,f,null,null,null,null,t,"5"+a),e.be("span",null,"6"+a,n,null,0),m(e,_,null,null,null,null,t,"7"+a),e.ee(),e.ee()):m(e,H,null,null,null,null,t,"8"+a),e.ee(),e.ee()}}e.ee(),e.ee()},{t:p},Q);l.Component=M(Q,l._);const X=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
