import{t as j}from"./index-iqhZMf16.js";import{t as p,r as m,b as d,g as z,h as G,f as H,p as J,d as _}from"./registry-BhN9Jjhp.js";import{_ as h}from"./v-element-Oz1uh6KN.js";import{_ as v}from"./render-tag-_0PNNh6Y.js";import"./_commonjsHelpers-5-cIlDoe.js";import"./_commonjs-dynamic-modules-h-SxKiO4.js";const K=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        ebay-switch
    </span>
...
`;class M extends Marko.Component{handleChange(e,s){this.input.disabled||this.emit("change",{originalEvent:e,value:s.value,checked:s.checked})}}const b="KBhefEPr",i=p(b),u=i;function P(){}const Q=h("span",{class:"switch__button"},"2",null,0,1);m.r(b,()=>M);const O={};i._=d(function(t,e,s,a,y,w){const{class:B,style:A,...N}=t;t.toJSON=P,e.be("span",{class:z(["switch",B]),style:G(A)},"0",a,null,1),e.e("input",H(J(N),{type:"checkbox",role:"switch",class:"switch__control"}),"1",a,0,4,{onchange:s.d("change","handleChange",!1)}),e.n(Q,a),e.ee()},{t:b,s:!0},O);i.Component=_(O,i._);const g="fTrlGwCp",c=p(g),R=h("label",{class:"field__label field__label--start",for:"switch"},"1",null,1,0).t("Option");m.r(g,()=>c);const L={};c._=d(function(t,e,s,a,y,w){e.be("span",{class:"field"},"0",a,null,1),e.n(R,a),v(u,{...t,id:"switch"},e,s,"2",[["change","emit",!1,["change"]]]),e.ee()},{t:g},L);c.Component=_(L,c._);const f="QXB7NAk8",l=p(f),V=h("label",{class:"field__label field__label--start field__label--disabled",for:"switch"},"1",null,1,0).t("Option");m.r(f,()=>l);const W={};l._=d(function(t,e,s,a,y,w){e.be("span",{class:"field"},"0",a,null,1),e.n(V,a),v(u,{...t,disabled:!0,id:"switch"},e,s,"2",[["change","emit",!1,["change"]]]),e.ee()},{t:f},W);l.Component=_(W,l._);const X=`import type { Input as SwitchInput } from "<ebay-switch>";
