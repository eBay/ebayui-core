import{b as h,a as W}from"./utils-DWCsNc5l.js";import{t as q}from"./index-CCz6reEH.js";import{C as y}from"./index-CiSZvFQX.js";import{r as b,b as g,d as f,t as k}from"./registry-B-klnak9.js";import{i as _,r}from"./attr-tag-DphMQldM.js";import{_ as x}from"./render-tag-BBOJ9dEX.js";import{_ as n}from"./const-element-Usj7mXQw.js";/* empty css             */import"./dynamic-tag-DQCvkDdb.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-B6IacUrT.js";import"./index-D8NY5PLw.js";import"./index-CSIGgAPs.js";/* empty css             */import"./index-blmbJU0z.js";import"./index-DYoOQ_vw.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";const G=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        ebay-fake-menu
    </span>
...
`,w="yZTFTjQk",s=k(w);b.r(w,()=>s);const F={};s._=g(function(c,o,i,t,B,C){x(y,_(()=>{r("items",{href:"#",current:!0,itemMatchesUrl:!1,renderBody:e=>{e.t("item 1",t)}}),r("items",{type:"button",renderBody:e=>{e.t("item 2",t)}}),r("items",{href:"#",renderBody:e=>{e.t("item 3",t)}})}),o,i,"0")},{t:w,i:!0},F);s.Component=f(F,s._);const O=`<ebay-fake-menu>
...
`),Q=n("span",{class:"sprite-flag",style:"background-position: 0 -25px"},0),Z=n("span",null,1).t("Austria"),H=n("span",{class:"sprite-flag",style:"background-position: 0 -100px"},0),J=n("span",null,1).t("Denmark"),L=n("span",{class:"sprite-flag",style:"background-position: 0 -275px"},0),X=n("span",null,1).t("Norway");b.r(T,()=>m);const K={};m._=g(function(c,o,i,t,B,C){o.n(P,t),x(y,_(()=>{r("items",{href:"#",renderBody:e=>{e.n(Q,t),e.n(Z,t)}}),r("items",{href:"#",renderBody:e=>{e.n(H,t),e.n(J,t)}}),r("items",{href:"#",renderBody:e=>{e.n(L,t),e.n(X,t)}})}),o,i,"1")},{t:T,i:!0},K);m.Component=f(K,m._);const Y=`<style>
    span.sprite-flag {
        background-image: url('https://ir.ebaystatic.com/pictures/aw/pics/cmp/ds3/sprds3_21.png');
        background-repeat: none;
        display: inline-block;
...
`,S="kSGKlyuc",p=k(S);b.r(S,()=>p);const V={};p._=g(function(c,o,i,t,B,C){x(y,_(()=>{r("items",{href:"#",renderBody:e=>{e.t("item 1 that has very long text",t)}}),r("items",{href:"#",renderBody:e=>{e.t("item 2",t)}}),r("items",{separator:!0}),r("items",{href:"#",renderBody:e=>{e.t("item 3",t)}}),r("items",{href:"#",renderBody:e=>{e.t("item 4",t)}}),r("items",{href:"#",renderBody:e=>{e.t("item 5",t)}})}),o,i,"0")},{t:S,i:!0},V);p.Component=f(V,p._);const ee=`<ebay-fake-menu>
