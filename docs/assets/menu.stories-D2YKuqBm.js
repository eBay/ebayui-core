import{b,a as U}from"./utils-DWCsNc5l.js";import{t as X}from"./index-CCz6reEH.js";import{_ as m}from"./index-CNrqrpGn.js";import{r as k,b as f,c as x,t as _}from"./registry-CtNeIPU8.js";import{i as B,r as a}from"./attr-tag-DphMQldM.js";import{_ as w}from"./render-tag-mtfFSHEK.js";import{_ as T}from"./empty-component-BCB5DEsP.js";import{_ as r}from"./const-element-D4l_3TxL.js";/* empty css             */import"./dynamic-tag-HMZVE1pc.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-BwvkvsZu.js";import"./index-B1-_MGqD.js";import"./index-B6qYX52F.js";/* empty css             */import"./of-fallback-C2gEBeKK.js";import"./index-eGtaP7gF.js";import"./index-DSBRYoSW.js";import"./index-DoeQzs2M.js";import"./index-D7GlLQHj.js";import"./index-D52eSIAE.js";import"./index-CbT4wDAv.js";import"./index-DnXwn7Kz.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";const Y=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        ebay-menu
    </span>
...
`,S="_tAvykum",u=_(S);k.r(S,()=>T);const M={};u._=f(function(i,n,s,t,C,v){w(m,B(()=>{a("items",{badgeNumber:1,ariaLabel:"1 item unread",renderBody:e=>{e.t("item 1 that has very long text",t)}}),a("items",{badgeNumber:99,ariaLabel:"99 items unread",renderBody:e=>{e.t("item 2",t)}}),a("items",{badgeNumber:10,ariaLabel:"10 item unread",renderBody:e=>{e.t("item 3",t)}})},{...i,items:void 0}),n,s,"0",[["keydown","emit",!1,["keydown"]],["change","emit",!1,["change"]],["select","emit",!1,["select"]]])},{t:S,s:!0},M);u.Component=x(M,u._);const Z=`<ebay-menu
    ...input
...
`,$="PF_DWcxd",y=_($),ee=r("style",null,1).t(`
    span.sprite-flag {
...
`),te=r("span",{style:"background-position: 0 -25px",class:"sprite-flag"},0),ae=r("span",null,1).t("Austria"),ne=r("span",{style:"background-position: 0 -100px",class:"sprite-flag"},0),ie=r("span",null,1).t("Denmark"),re=r("span",{style:"background-position: 0 -275px",class:"sprite-flag"},0),se=r("span",null,1).t("Norway");k.r($,()=>T);const Q={};y._=f(function(i,n,s,t,C,v){n.n(ee,t),w(m,B(()=>{a("items",{renderBody:e=>{e.n(te,t),e.n(ae,t)}}),a("items",{renderBody:e=>{e.n(ne,t),e.n(ie,t)}}),a("items",{renderBody:e=>{e.n(re,t),e.n(se,t)}})},{text:"Country",...i,items:void 0}),n,s,"1",[["keydown","emit",!1,["keydown"]],["change","emit",!1,["change"]],["select","emit",!1,["select"]]])},{t:$,s:!0},Q);y.Component=x(Q,y._);const oe=`<style>
    span.sprite-flag {
        background-image: url('https://ir.ebaystatic.com/pictures/aw/pics/cmp/ds3/sprds3_21.png');
        background-repeat: none;
        display: inline-block;
...
`,A="$hWwQAr",h=_(A),me=r("h3",null,1).t("Click inside the menu, then type a name to see focus change. The search will see if any names start with the input, then if there are no matches it will search for the input string anywhere in the names."),de=r("h4",null,1).t("Wait 2 seconds for the typeahead to reset and then try typing again to reset the search.");k.r(A,()=>T);const G={};h._=f(function(i,n,s,t,C,v){n.n(me,t),n.n(de,t),w(m,B(()=>{a("items",{renderBody:e=>{e.t("Albania",t)}}),a("items",{renderBody:e=>{e.t("Alcania",t)}}),a("items",{renderBody:e=>{e.t("Alcdnia",t)}}),a("items",{renderBody:e=>{e.t("Austen",t)}}),a("items",{renderBody:e=>{e.t("Austin",t)}}),a("items",{renderBody:e=>{e.t("Jack",t)}}),a("items",{renderBody:e=>{e.t("Jackman",t)}}),a("items",{renderBody:e=>{e.t("Jackson",t)}}),a("items",{renderBody:e=>{e.t("Jasper",t)}}),a("items",{renderBody:e=>{e.t("Julia",t)}}),a("items",{renderBody:e=>{e.t("Julio",t)}}),a("items",{renderBody:e=>{e.t("Julius",t)}}),a("items",{renderBody:e=>{e.t("Luca",t)}}),a("items",{renderBody:e=>{e.t("Lucais",t)}}),a("items",{renderBody:e=>{e.t("Lucan",t)}}),a("items",{renderBody:e=>{e.t("Lucian",t)}}),a("items",{renderBody:e=>{e.t("Lucius",t)}})},{text:"Button",...i,items:void 0}),n,s,"2",[["keydown","emit",!1,["keydown"]],["change","emit",!1,["change"]],["select","emit",!1,["select"]]])},{t:A,s:!0},G);h.Component=x(G,h._);const ce=`<h3>
...
`,J="sMtOyITe",g=_(J);k.r(J,()=>T);const H={};g._=f(function(i,n,s,t,C,v){w(m,B(()=>{a("items",{renderBody:e=>{e.t("item 1 that has very long text",t)}}),a("items",{renderBody:e=>{e.t("item 2",t)}}),a("items",{separator:!0}),a("items",{renderBody:e=>{e.t("item 3",t)}}),a("items",{renderBody:e=>{e.t("item 4",t)}}),a("items",{renderBody:e=>{e.t("item 5",t)}})},{...i,items:void 0}),n,s,"0",[["keydown","emit",!1,["keydown"]],["change","emit",!1,["change"]],["select","emit",!1,["select"]]])},{t:J,s:!0},H);g.Component=x(H,g._);const le=`<ebay-menu
    ...input
    on-keydown('emit', 'keydown')
    on-change('emit', 'change')
    on-select('emit', 'select')
