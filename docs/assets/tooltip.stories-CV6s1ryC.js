import{t as Y}from"./index-CCz6reEH.js";import{a as z}from"./utils-DWCsNc5l.js";import{t as k,r as v,b as x,d as N,p as O,c as S}from"./registry-BVpmXZbM.js";/* empty css                    *//* empty css                */import{_ as P}from"./index-DzsoYed3.js";import{_ as r}from"./render-tag-mtfFSHEK.js";import{_ as q}from"./dynamic-tag-CptWGHl0.js";import{_ as G,a as J}from"./index-CNB4LfFD.js";import{h as L}from"./index-blmbJU0z.js";import{_ as Q}from"./index-BigETXv0.js";import{i as W,a as h}from"./attr-tag-DphMQldM.js";import{_ as X}from"./const-element-St90kC48.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-BFFaizzc.js";import"./index-DNKYtym0.js";/* empty css             */import"./index-D7B88Psz.js";import"./index-D7GlLQHj.js";import"./index--35j0Bzx.js";const Z=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        ebay-tooltip
    </span>
...
`;class D extends Marko.Component{onCreate(){this.state={open:!1}}onInput(e){(e.open===!0||e.open===!1)&&(this.state.open=e.open)}handleExpand(){this.state.open=!0,this.emit("expand")}handleCollapse(){this.state.open=!1,this.emit("collapse")}handleKeydown(e){L(e,()=>{this.state.open=!1})}}const d="YfTPmpyg",p=k(d),T=p,ee=typeof window<"u";v.r(d,()=>p);const C=D;p._=x(function(o,e,t,i,m,B){const{content:n,heading:$,host:V,noHover:H,offset:K,placement:A,pointer:R="bottom",noShift:F,notInline:U,noFlip:j,...M}=o;ee&&m.open&&r(P,{to:typeof window=="object"&&document,__events:["on","keydown"]},e,t,"0",[["keydown","handleKeydown",!1]]),e.be("span",null,"1",i,null,0),r(G,{open:m.open,type:"tooltip",overlayId:t.elId("overlay"),noFlip:j,notInline:U,noShift:F,noHover:H,pointer:R,placement:A,offset:K,renderBody:c=>{c.be("span",N(O(M),{class:"tooltip"}),"2",i,null,4,{pa:{class:1}}),q(c,V,null,null,null,null,t,"3"),r(J,{type:"tooltip",id:t.elId("overlay"),heading:$,content:n},c,t,"4"),c.ee()}},e,t,"@base",[["base-expand","handleExpand",!1],["base-collapse","handleCollapse",!1]]),e.ee()},{t:d},C);p.Component=S(C,p._);const b="MRvnaVde",l=k(b),te=X("p",null,1).t("Use Access Key 'S' to display settings.");v.r(b,()=>l);const E={};l._=x(function(o,e,t,i,m,B){r(T,W(()=>{h("host",{renderBody:n=>{n.be("button",{name:"icon-btn-1",accesskey:"i",class:"icon-btn tooltip__host",type:"button","aria-label":"Developer-handled label"},"1",i,null,0),r(Q,{},n,t,"2"),n.ee()}}),h("content",{renderBody:n=>{n.n(te,i)}})},{open:o.open}),e,t,"0")},{t:b,i:!0},E);l.Component=S(E,l._);const oe=`export interface Input {
    open: boolean;
}
...
})`,...(w=(g=s.parameters)==null?void 0:g.docs)==null?void 0:w.source}}};const Te=["Standard","buttonHost"];export{a as Standard,Te as __namedExportsOrder,s as buttonHost,Se as default};
