import{t as D}from"./index-CCz6reEH.js";import{b as j,a as M}from"./utils-DWCsNc5l.js";import{t as $,r as E,b as z,e as Q,p as Y,f as q,h as G,d as B}from"./registry-B-klnak9.js";import{_ as J}from"./dynamic-tag-DQCvkDdb.js";import{_ as K}from"./index-CirIKg0T.js";import{_ as I}from"./render-tag-BBOJ9dEX.js";import{i as L,a as N}from"./attr-tag-DphMQldM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-Bd083XES.js";/* empty css             */const b=["teal","light-teal","green","lime","yellow","orange","magenta","pink"];function P(e,a){if(a)return a;let t=0,o,n;if(e&&e.length>0)for(n=0;n<e.length;n++)o=e.charCodeAt(n),t=(t<<5)-t+o,t|=0;const l=b.length,p=Math.abs(t)%l;return b[p]}const d="EbwFumYg",i=$(d),O=i;E.r(d,()=>i);const A={};i._=z(function(e,a,t,o,n,l){const{a11yText:p,class:H,size:u,color:U,img:y,username:g,renderBody:V,...W}=e;a.be("div",Q(Y(W),{role:"img","aria-label":p,class:q(["avatar",H,u&&`avatar--${u}`,`avatar--${P(g,U)}`])}),"0",o,null,4),y?a.e("img",G(y),"1",o,0,4):V?J(a,e,null,null,null,null,t,"2"):g?a.t(g.charAt(0).toUpperCase(),o):I(K,{},a,t,"3"),a.ee()},{t:d,i:!0},A);i.Component=B(A,i._);const X=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        ebay-avatar
    </span>
