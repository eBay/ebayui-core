import{t as D}from"./index-CCz6reEH.js";import{b as j,a as G}from"./utils-DWCsNc5l.js";import{t as $,r as z,b as B,e as M,p as Z,f as q,h as J,d as E}from"./registry-DoALHDDx.js";import{_ as K}from"./dynamic-tag-B1GLaPEW.js";import{_ as L}from"./index-WTRPKVno.js";import{_ as I}from"./render-tag-BBOJ9dEX.js";import{i as N,a as P}from"./attr-tag-DphMQldM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-mP6JM4Am.js";/* empty css             */const b=["teal","light-teal","green","lime","yellow","orange","magenta","pink"];function Q(e,a){if(a)return a;let t=0,o,n;if(e&&e.length>0)for(n=0;n<e.length;n++)o=e.charCodeAt(n),t=(t<<5)-t+o,t|=0;const l=b.length,p=Math.abs(t)%l;return b[p]}const g="hwbmouFG",i=$(g),O=i;z.r(g,()=>i);const A={};i._=B(function(e,a,t,o,n,l){const{a11yText:p,class:F,size:u,color:H,img:y,username:d,renderBody:U,...W}=e;a.be("div",M(Z(W),{role:"img","aria-label":p,class:q(["avatar",F,u&&`avatar--${u}`,`avatar--${Q(d,H)}`])}),"0",o,null,4),y?a.e("img",J(y),"1",o,0,4):U?K(a,e,null,null,null,null,t,"2"):d?a.t(d.charAt(0).toUpperCase(),o):I(L,{},a,t,"3"),a.ee()},{t:g,i:!0},A);i.Component=E(A,i._);const X=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        ebay-avatar
    </span>
