import{a as K}from"./utils-DWCsNc5l.js";import{t as Q}from"./index-CCz6reEH.js";import{t as Y,r as ee,b as te,e as ue,p as T,f as W,d as ae}from"./registry-D0x2Lw0V.js";import{_ as me,a as Z,b as pe}from"./index-VW1amDs5.js";import{g as ge}from"./index-vXSNXTGb.js";/* empty css             *//* empty css                    */import{_ as P}from"./render-tag-Buaq4gMc.js";import{_ as B}from"./dynamic-tag-BSuzyz1c.js";import{i as re,r as $}from"./attr-tag-W-ozfNNY.js";import{_ as he}from"./index-Dhzq5Dqr.js";import{r as be}from"./index-blmbJU0z.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-BZpHAKBe.js";import"./index-D-Xj9adi.js";/* empty css               *//* empty css             */import"./index-ClYQ9iWr.js";import"./index-CrY4xSt-.js";import"./index-BFNHZk0m.js";import"./index-DBdq2wPY.js";import"./index-dZMhXc9l.js";/* empty css                    */import"./index-qntjFark.js";import"./index-CPUcvrin.js";import"./index-DInjN7_O.js";/* empty css             */import"./index-C37XbWVa.js";import"./index-DYoOQ_vw.js";import"./index-D7B88Psz.js";import"./index-D7GlLQHj.js";import"./index--35j0Bzx.js";const ye=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        ebay-pagination
    </span>
...
`,fe=9,xe=5;class ve extends Marko.Component{handlePageNumberClick(e,t,a){this.emit("select",{el:a,originalEvent:t,value:a.innerText,index:e})}handleMenuPageNumber({originalEvent:e,el:t}){const a=parseInt(t==null?void 0:t.getAttribute("data-page-number"),10);this.emit("select",{el:t,originalEvent:e,value:(t==null?void 0:t.innerText)??"",index:a}),setTimeout(()=>this.getEl("pageItem[]",a).focus(),0)}handleNextPageClick(e,t){t.hasAttribute("aria-disabled")||this.emit("next",{el:t,originalEvent:e})}handlePreviousPageClick(e,t){t.hasAttribute("aria-disabled")||this.emit("previous",{el:t,originalEvent:e})}onCreate(){this.state={maxItems:0}}onMount(){this._calculateMaxItems(),this.subscribeTo(be).on("resize",this._calculateMaxItems.bind(this))}getItemTag(e){return e.variant?e.variant==="link"?"a":"button":e.href?"a":"button"}_getVisibleRange(e){const{state:t,input:a}=this,{maxItems:s}=t,{variant:p}=a,g=p==="show-last"||p==="overflow",n=p==="overflow",b=p==="overflow",d=e.length-1,E=g?d:-1,y=n?1:-1;let c=!1,u=!1;if(!s)return{start:0,end:d,hideDots:!0,dotsIndex:E,leadingDotsIndex:y,hasOverflow:b};const m=e.findIndex(f=>f.current),i=Math.floor(s/2);let o=m-i,l=m+i;return o<=0?(l=s-1,o=0):l>=d?(l=d,o=d-(s-1)):s%2===0&&o++,g&&(m+i>=d||l>=d?c=!0:m<=l-2?l-=2:(o+=1,l-=1)),n&&(m-i<=0?u=!0:m>=o-1?o+=2:(l-=1,o-=1)),{start:o,end:l,hideDots:c,dotsIndex:E,hasOverflow:b,leadingDotsIndex:y,hideLeadingDots:u}}_calculateMaxItems(){const{input:e,state:t}=this;if(!(e.items||[]).some(n=>!n.type))return;const s=this.getEl("items"),p=this.getEl("root"),g=this._itemWidth||(this._itemWidth=s.firstElementChild.offsetWidth);t.maxItems=Math.max(xe,Math.min(fe,Math.floor(ge(p)/g)-2))}}const V="L1rRwgnS",C=Y(V),ne=C;var M={disabled:!0},_e=["items"],N=["current","disabled"];function j(r,e){return(r<e.start||r>e.end)&&e.dotsIndex!==r&&e.leadingDotsIndex-1!==r}ee.r(V,()=>C);const ie=ve;C._=te(function(r,e,t,a,s,p){const{class:g,items:n=[],a11yCurrentText:b="Results Pagination - Page 1",a11yPreviousText:d="Previous page",a11yNextText:E="Next page"}=r;var y=n.length-1,c=n[0]&&n[0].type==="previous"&&n[0]||M,u=n[y]&&n[y].type==="next"&&n[y]||M,m=n.slice(c===M?0:1,u===M?void 0:y),i=a._getVisibleRange(m);e.be("nav",ue(T(r,_e),{role:"navigation",class:W(["pagination",g]),"aria-labelledby":t.elId("heading")}),"@root",a,null,4),e.be("span",{"aria-live":"polite",role:"status"},"0",a,null,0),e.be("h2",{id:t.elId("heading"),class:"clipped"},"1",a,null,1),e.t(b,a),e.ee(),e.ee(),B(e,a.getItemTag(c),()=>({...T(c,N),class:["pagination__previous",c.href?"icon-link":"icon-btn",c.class],"aria-disabled":c.disabled&&"true","aria-label":d,style:[c.style,{minWidth:40}]}),f=>{P(me,{},f,t,"3")},null,null,t,"2",[["click","handlePreviousPageClick",!1]]),e.be("ol",{class:"pagination__items"},"@items",a,null,1);{let f=0;for(const x of m||[]){let I=f++;const h=`[${I}]`;if(i.dotsIndex===I||i.leadingDotsIndex===I){var o=i.hideDots,l=!1;i.leadingDotsIndex===I&&(l=!0,o=!!i.hideLeadingDots),e.be("li",{hidden:o},"4"+h,a,null,0),i.hasOverflow?(e.be("span",{class:W(["pagination__item",x.class]),role:"separator"},"5"+h,a,null,0),P(he,re(()=>{let R=0;for(const A of m||[]){let w=R++;const de=`[${w+h}]`;var le=l?w<i.start:w>i.end;j(w,i)&&le&&$("items",{...T(A,N),type:a.getItemTag(A),dataPageNumber:w,renderBody:ce=>{B(ce,A.renderBody,null,null,null,null,t,"7"+de)}})}},{variant:"icon",transparent:!0,icon:Z,collapseOnSelect:!0}),e,t,"6"+h,[["select","handleMenuPageNumber",!1]]),e.ee()):(e.be("span",{class:W(["pagination__item",x.class]),role:"separator"},"8"+h,a,null,0),P(Z,{},e,t,"9"+h),e.ee()),e.ee()}e.be("li",{hidden:j(I,i)},"10"+h,a,null,0),B(e,a.getItemTag(x),()=>({...T(x,N),class:["pagination__item",x.class],"aria-current":x.current&&"page"}),R=>{B(R,x.renderBody,null,null,null,null,t,"11"+h)},null,null,t,"@pageItem[]",[["click","handlePageNumberClick",!1,[I]]]),e.ee()}}e.ee(),B(e,a.getItemTag(u),()=>({...T(u,N),class:["pagination__next",u.href?"icon-link":"icon-btn",u.class],"aria-disabled":u.disabled&&"true","aria-label":E,style:[u.style,{minWidth:40}]}),f=>{P(pe,{},f,t,"13")},null,null,t,"12",[["click","handleNextPageClick",!1]]),e.ee()},{t:V},ie);C.Component=ae(ie,C._);const D="m7iwF6L0",S=Y(D),L=15;ee.r(D,()=>S);const se={onCreate(){this.state={current:0}},handlePrev(r){this.state.current=Math.max(this.state.current-1,0),this.emit("previous",r)},handleNext(r){this.state.current=Math.min(this.state.current+1,L),this.emit("next",r)},handleSelect({index:r},e){this.state.current=r,this.emit("select",e)}};S._=te(function(r,e,t,a,s,p){P(ne,re(()=>{$("items",{type:"previous",disabled:s.current===0});for(let g=(L-0)/1,n=0;n<=g;n++){const b=0+n*1;$("items",{current:b===s.current,renderBody:d=>{d.t(b,a)}})}$("items",{type:"next",disabled:s.current===L})},{a11yCurrentText:`Results Pagination - Page ${s.current}`,...r}),e,t,"0",[["next","handleNext",!1],["previous","handlePrev",!1],["select","handleSelect",!1]])},{t:D},se);S.Component=ae(se,S._);const Ie=`static const SIZE = 15;
