import{t as H}from"./index-iqhZMf16.js";import{b as L,a as X}from"./utils-NX-dnf4r.js";import{t as z,r as Q,b as W,f as x,g as B,p as v,d as w}from"./registry-EgEQwbXk.js";import{_ as b}from"./dynamic-tag-7vXwaVzE.js";import{_ as Y,a as F}from"./index-HX0YqcZh.js";import{_ as p}from"./render-tag-_0PNNh6Y.js";import{_ as c}from"./self-iterator-6yU_KG2T.js";import"./_commonjsHelpers-5-cIlDoe.js";import"./_commonjs-dynamic-modules-h-SxKiO4.js";import"./index-rIGlTtcv.js";/* empty css             */const G=["large"];class J extends Marko.Component{onCreate(){this.state={selectedIndex:0}}onInput(e){let t=(e.buttons||[]).findIndex(n=>n.selected);t===-1&&(t=0),this.state.selectedIndex=t}onButtonClick(e,t){e!==this.state.selectedIndex&&(this.state.selectedIndex=e,this.emit("change",{index:e,value:(this.input.buttons[e]||{}).value||void 0,originalEvent:t}))}}const g="LNSA3gQY",i=z(g),q=i;Q.r(g,()=>i);const A=J;i._=W(function(s,e,t,n,h,M){let{size:a,class:o,buttons:Z,...R}=s;var _=a&&G.includes(a)?a:null;e.be("div",x({class:B(["segmented-buttons",_&&`segmented-buttons--${_}`,s.class])},v(R)),"0",n,null,4),e.be("ul",null,"1",n,null,0);{let V=0;for(const f of s.buttons||[]){let m=V++;const r=`[${m}]`,{class:j,icon:k,renderBody:D,...N}=f;e.be("li",null,"2"+r,n,null,0),e.be("button",x({class:B(["segmented-buttons__button",j]),"aria-current":h.selectedIndex===m&&"true"},v(N)),"3"+r,n,null,4,{onclick:t.d("click","onButtonClick",!1,[m])}),k?(e.be("span",{class:"segmented-buttons__button-cell"},"4"+r,n,null,1),b(e,k,null,null,null,null,t,"5"+r),e.be("span",null,"6"+r,n,null,0),b(e,f,null,null,null,null,t,"7"+r),e.ee(),e.ee()):b(e,D,null,null,null,null,t,"8"+r),e.ee(),e.ee()}}e.ee(),e.ee()},{t:g},A);i.Component=w(A,i._);const K=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
