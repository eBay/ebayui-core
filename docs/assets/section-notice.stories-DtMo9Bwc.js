import{t as Q}from"./index-CCz6reEH.js";import{b as I,a as tt}from"./utils-DWCsNc5l.js";import{t as _,r as k,b as T,d as x}from"./registry-D0x2Lw0V.js";/* empty css             */import{_ as et}from"./index-BDUYaZQN.js";import{_ as c}from"./render-tag-Buaq4gMc.js";import{_ as i}from"./const-element-DTwCHAHi.js";import{i as E,a as m}from"./attr-tag-W-ozfNNY.js";import{_ as ot}from"./index-DfqKTg73.js";import{_ as nt}from"./index-Bo9o9O1u.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-2nADucOP.js";import"./index-BZpHAKBe.js";import"./index-G54t06By.js";import"./dynamic-tag-BSuzyz1c.js";import"./index-Cb2Litza.js";/* empty css             */import"./index-blmbJU0z.js";const it=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        ebay-section-notice
    </span>
...
`;class at extends Marko.Component{onCreate(){this.state={dismissed:!1}}onInput(n){this.state={dismissed:n.dismissed||!1}}onDismiss(){this.state.dismissed=!0,this.emit("dismiss")}}const D="OCFpWpE+",d=_(D),w=d;k.r(D,()=>d);const U=at;d._=T(function(o,n,a,e,y,C){const{a11yRoleDescription:t="Notice",status:h,class:Y,...Z}=o;y.dismissed||c(et,{...Z,status:h,role:"region",prefixClass:"section-notice",type:"section",mainRoot:"span",a11yRoleDescription:t,class:[h==="education"&&"section-notice--large-icon",Y]},n,a,"0",[["dismiss","onDismiss",!1]])},{t:D},U);d.Component=x(U,d._);const S="VQ1tlugC",p=_(S),st=i("div",null,1).t("Notice title"),rt=i("p",null,2).e("strong",null,1).t("Error:").t(" Please take another look at the following:"),ct=i("p",null,5).e("a",{href:"#"},1).t("Card number").t(", ").e("a",{href:"#"},1).t("Expiration date").t(" & ").e("a",{href:"#"},1).t("Security code");k.r(S,()=>p);const G={};p._=T(function(o,n,a,e,y,C){c(w,E(()=>(m("title",{renderBody:t=>{t.n(st,e)}}),m("footer",{renderBody:t=>{c(ot,{renderBody:h=>{h.t("Footer",e)}},t,a,"2")}}),t=>{t.n(rt,e),t.n(ct,e)}),{...o}),n,a,"0")},{t:S,i:!0},G);p.Component=x(G,p._);const mt=`import type { Input as SectionNoticeInput } from "<ebay-section-notice>"
...
`,B="gIBlDN2z",l=_(B),dt=i("div",null,1).t("Notice title"),pt=i("p",null,1).t("The eBay vault will store items for you."),lt=i("p",null,1).e("a",{href:"#"},1).t("Try it");k.r(B,()=>l);const H={};l._=T(function(o,n,a,e,y,C){c(w,E(()=>(m("title",{renderBody:t=>{t.n(dt,e)}}),t=>{t.n(pt,e),t.n(lt,e)}),{...o,educationIcon:nt,a11yText:"ebay vault"}),n,a,"0")},{t:B,i:!0},H);l.Component=x(H,l._);const ut=`import TheVaultIcon from '<ebay-the-ebay-vault-24-icon>'
...
`,$="9qmcJqBD",u=_($),yt=i("div",null,1).t("Notice title"),ht=i("p",null,2).e("strong",null,1).t("Error:").t(" Please take another look at the following:"),ft=i("p",null,5).e("a",{href:"#"},1).t("Card number").t(", ").e("a",{href:"#"},1).t("Expiration date").t(" & ").e("a",{href:"#"},1).t("Security code");k.r($,()=>u);const K={};u._=T(function(o,n,a,e,y,C){c(w,E(()=>(m("title",{renderBody:t=>{t.n(yt,e)}}),m("cta",{href:"https://www.ebay.com",renderBody:t=>{t.t("Link here",e)}}),t=>{t.n(ht,e),t.n(ft,e)}),{...o}),n,a,"0",[["dismiss","emit",!1,["dismiss"]]])},{t:$},K);u.Component=x(K,u._);const bt=`import type { Input as SectionNoticeInput } from "<ebay-section-notice>"
export type Input = SectionNoticeInput;
