import{t as Q}from"./index-CCz6reEH.js";import{a as V}from"./utils-DWCsNc5l.js";import{c as b}from"./index-BfEgRTc6.js";import{r as y,b as h,d as f,t as _}from"./registry-B-klnak9.js";import{i as T,a as c}from"./attr-tag-DphMQldM.js";import{_ as Z}from"./index-WKJwowiZ.js";import{_ as p}from"./render-tag-BBOJ9dEX.js";import{_ as S}from"./empty-component-BCB5DEsP.js";import{_ as U}from"./const-element-Usj7mXQw.js";import"./dynamic-tag-DQCvkDdb.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-CSIGgAPs.js";/* empty css             */const q=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        ebay-toggle-button
    </span>
...
`,k="lkiUvFp",u=_(k);y.r(k,()=>S);const j={};u._=h(function(t,l,a,o,v,I){p(b,T(()=>(c("subtitle",{renderBody:e=>{e.t("Subtitle",o)}}),c("icon",{renderBody:e=>{p(Z,{},e,a,"1")}}),e=>{e.t("Title",o)}),{layoutType:"list",...t,subtitle:void 0,icon:void 0}),l,a,"0",[["toggle","emit",!1,["toggle"]]])},{t:k,s:!0},j);u.Component=f(j,u._);const J=`<ebay-toggle-button layoutType="list" ...input onToggle("emit", "toggle")>
    Title
    <@subtitle>Subtitle</@subtitle>
    <@icon><ebay-archive-24-icon/></@icon>
</ebay-toggle-button>
`,x="zKtQkrZ",m=_(x);y.r(x,()=>S);const G={};m._=h(function(t,l,a,o,v,I){const{src:e,alt:O,fillPlacement:F,...H}=t;p(b,T(()=>(c("subtitle",{renderBody:d=>{d.t("Subtitle",o)}}),c("img",{src:e,alt:O,fillPlacement:F}),d=>{d.t("Title",o)}),{layoutType:"list",...H,subtitle:void 0,img:void 0}),l,a,"0",[["toggle","emit",!1,["toggle"]]])},{t:x,s:!0},G);m.Component=f(G,m._);const N=`$ const { src, alt, fillPlacement, ...buttonInput } = input
<ebay-toggle-button layoutType="list" ...buttonInput onToggle("emit", "toggle")>
    Title
    <@subtitle>Subtitle</@subtitle>
    <@img src=src alt=alt fillPlacement=fillPlacement />
</ebay-toggle-button>
`,w="hwpwnSK",g=_(w),X=U("p",null,1).t("Subtitle 1"),Y=U("p",null,1).t("Subtitle 2");y.r(w,()=>S);const K={};g._=h(function(t,l,a,o,v,I){p(b,T(()=>(c("subtitle",{renderBody:e=>{e.n(X,o),e.n(Y,o)}}),e=>{e.t("Title",o)}),{layoutType:"list",...t,subtitle:void 0}),l,a,"0",[["toggle","emit",!1,["toggle"]]])},{t:w,s:!0},K);g.Component=f(K,g._);const tt=`<ebay-toggle-button layoutType="list" ...input onToggle("emit", "toggle")>
    Title
    <@subtitle>
        <p>Subtitle 1</p>
        <p>Subtitle 2</p>
