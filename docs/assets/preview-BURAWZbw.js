import{a as g,x as s}from"./index-DLwKo1LO.js";const{global:H}=__STORYBOOK_MODULE_GLOBAL__;var r="storybook/highlight",a="storybookHighlight",m=`${r}/add`,_=`${r}/reset`,{document:h}=H,I=(e="#FF4785",t="dashed")=>`
  outline: 2px ${t} ${e};
  outline-offset: 2px;
