import{t as A}from"./index-iqhZMf16.js";import{t as x,r as T,b as S,f as G,g as y,p as K,d as w}from"./registry-BhN9Jjhp.js";import{_ as P}from"./index-_Jd98rBz.js";import{_ as E}from"./render-tag-_0PNNh6Y.js";import{_ as z}from"./v-element-Oz1uh6KN.js";import"./_commonjsHelpers-5-cIlDoe.js";import"./_commonjs-dynamic-modules-h-SxKiO4.js";import"./index-gdhiSckb.js";/* empty css             */const D=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
...
`;class H extends Marko.Component{onCreate(){this.state={value:0}}onInput(e){let t=parseInt(e.value)||0;t>5&&(t=0),this.state.value=t}emitEvent(e,t,n,l){l.disabled||(this.state.value=t,this.emit(e,{originalEvent:n,value:t}))}}const p="L0GfGBDo",i=x(p),C=i;T.r(p,()=>i);const B=H;i._=S(function(a,e,t,n,l,F){const{class:R,value:q,a11yText:g,a11yStarText:$=[],disabled:j,...O}=a;e.be("div",G({role:!!g&&"radiogroup","aria-label":g,class:y(["star-rating-select",R])},K(O)),"0",n,null,4);for(let V=4/1,m=0;m<=V;m++){const s=1+m*1,d=`[${s}]`;e.be("span",{class:"star-rating-select__radio"},"1"+d,n,null,1),e.e("input",{"aria-label":$[s-1],class:y(["star-rating-select__control",s<=l.value&&"star-rating-select__control--filled"]),type:"radio",name:t.elId("star-rating"),value:s,disabled:j,checked:l.value===s},"2"+d,n,0,0,{onclick:t.d("click","emitEvent",!1,["change",s]),onfocus:t.d("focus","emitEvent",!1,["focus",s]),onkeydown:t.d("keydown","emitEvent",!1,["keydown",s])}),e.be("span",{class:"star-rating-select__radio-icon"},"3"+d,n,null,1),E(P,{},e,t,"4"+d),e.ee(),e.ee()}e.ee()},{t:p},B);i.Component=w(B,i._);const u="paD0yFOo",c=x(u),L=z("legend",null,"1",null,1,0).t("Rate Product");T.r(u,()=>c);const I={};c._=S(function(a,e,t,n,l,F){e.be("fieldset",null,"0",n,null,0),e.n(L,n),E(C,{value:a.value,a11yStarText:a.a11yStarText},e,t,"2",[["change","emit",!1,["change"]],["keydown","emit",!1,["keydown"]],["focus","emit",!1,["focus"]]]),e.ee()},{t:u},I);c.Component=w(I,c._);const M=`export interface Input {
    value: number;
    a11yStarText: string;
}
