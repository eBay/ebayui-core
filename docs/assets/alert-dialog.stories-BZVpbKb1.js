import{a as Q}from"./utils-DWCsNc5l.js";import{r as k,b as w,d as x,t as T}from"./registry-D0x2Lw0V.js";import{_ as a}from"./dynamic-tag-BSuzyz1c.js";import{i as C,a as c}from"./attr-tag-W-ozfNNY.js";import{_ as V}from"./const-element-DTwCHAHi.js";import{_ as E}from"./index-CrY4xSt-.js";import{_ as d}from"./render-tag-Buaq4gMc.js";import{_ as j}from"./index-naZEvJVz.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";/* empty css               */import"./index-BFNHZk0m.js";import"./index-DBdq2wPY.js";import"./index-BZpHAKBe.js";/* empty css             */import"./index-dZMhXc9l.js";import"./index-blmbJU0z.js";/* empty css                    */import"./index-Cb2Litza.js";import"./index-BWLs-RUD.js";import"./index--35j0Bzx.js";const K=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        ebay-alert-dialog
    </span>
...
`,p="6eDQvQ0j",l=T(p);k.r(p,()=>l);const D={};l._=w(function(n,s,o,t,g,v){var e=t.getElId("alert-dialog-confirm"),y=t.getElId("alert-dialog-main");const{class:I,confirmText:f,confirm:O,renderBody:R,...S}=n,{renderBody:A,...M}=O||{};d(j,C(()=>(c("footer",{renderBody:m=>{d(E,{priority:"primary",ariaDescribedby:y,id:e,class:"alert-dialog__acknowledge",...M,renderBody:b=>{f?b.t(f,t):a(b,A,null,null,null,null,o,"1")}},m,o,"@confirm",[["click","emit",!1,["confirm"]]])}}),m=>{a(m,R,null,null,null,null,o,"2")}),{...S,role:"alertdialog",classPrefix:"alert-dialog",ignoreEscape:!0,mainId:y,buttonPosition:"hidden",focus:e,class:[I,"alert-dialog--mask-fade"],windowClass:["alert-dialog__window alert-dialog__window--fade"]}),s,o,"0",[["open","emit",!1,["open"]],["close","emit",!1,["close"]]])},{t:p,i:!0},D);l.Component=x(D,l._);const u="3f5QmEug",i=T(u),P=i,z=V("p",null,1).t("This 'alert' text should be 1-2 lines.");k.r(u,()=>i);const $={onCreate(){this.state={open:!1}},openDialog(){this.state.open=!0},closeDialog(){this.state.open=!1,this.emit("confirm")}};i._=w(function(n,s,o,t,g,v){d(l,C(()=>(c("header",{renderBody:e=>{a(e,n.header.renderBody,null,null,null,null,o,"1")}}),c("confirm",{renderBody:e=>{a(e,n.confirm.renderBody,null,null,null,null,o,"2")}}),e=>{a(e,n.renderBody,null,null,null,null,o,"3"),e.n(z,t)}),{open:g.open}),s,o,"0",[["open","emit",!1,["open"]],["close","emit",!1,["close"]],["confirm","closeDialog",!1]]),d(E,{renderBody:e=>{e.t("Open Alert Dialog",t)}},s,o,"5",[["click","openDialog",!1]])},{t:u},$);i.Component=x($,i._);const F=`export interface Input {
