import{a as E}from"./utils-DWCsNc5l.js";import{t as F,r as N,b as V,d as c,p as m,e as b,c as P}from"./registry-BVpmXZbM.js";/* empty css                    */import{_ as h}from"./dynamic-tag-CptWGHl0.js";import{i as $,a as A}from"./attr-tag-DphMQldM.js";import{_ as K,a as j}from"./index-CNB4LfFD.js";import{_ as f}from"./render-tag-mtfFSHEK.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-BFFaizzc.js";import"./index-DNKYtym0.js";/* empty css             */import"./index-D7B88Psz.js";import"./index-D7GlLQHj.js";import"./index--35j0Bzx.js";const z=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        ebay-tourtip
    </span>
...
`;class H extends Marko.Component{handleCollapse({originalEvent:e}){this.state.expanded&&(this.state.expanded=!1,this.emit("collapse",{originalEvent:e}))}handleExpand({originalEvent:e}){this.state.expanded||(this.state.expanded=!0,this.emit("expand",{originalEvent:e}))}onInput(e){(e.open===!1||e.open===!0)&&(this.state.expanded=e.open)}onCreate(){this.state={expanded:!0}}}const u="KsiQKscg",l=F(u),M=l;N.r(u,()=>l);const w=H;l._=V(function(t,e,i,r,v,G){const{a11yCloseText:B,content:C,footer:s,heading:I,host:d,open:J,noFlip:S,notInline:L,noShift:R=!0,pointer:U="bottom",...D}=t;e.be("span",null,"0",r,null,0),f(K,{type:"tourtip",noFlip:S,notInline:L,noShift:R,pointer:t.pointer,placement:t.placement,offset:t.offset,overlayId:i.elId("overlay"),renderBody:o=>{o.be("span",c(m(D),{class:b(["tourtip",v.expanded&&"tourtip--expanded"])}),"1",r,null,4),d&&(o.be("span",c({class:b([d.class,"tourtip__host"])},m(d)),"2",r,null,4),h(o,d.renderBody,null,null,null,null,i,"3"),o.ee()),f(j,$(()=>{s&&A("footer",{class:[s.class],renderBody:p=>{s.index&&(p.be("span",{class:"tourtip__index"},"5",r,null,1),p.t(s.index,r),p.ee()),h(p,s,null,null,null,null,i,"6")}})},{type:"tourtip",id:i.elId("overlay"),heading:I,content:C,a11yCloseText:B}),o,i,"4",[["overlay-close","handleCollapse",!1]]),o.ee()}},e,i,"@base"),e.ee()},{t:u},w);l.Component=P(w,l._);const O=`<ebay-tourtip a11yCloseText="Dismiss tourtip">
    <@host>
        <p>
