import{t as P}from"./index-CCz6reEH.js";import{b as Z,a as F}from"./utils-DWCsNc5l.js";import{t as z,r as q,b as W,d as k,e as x,p as v,c as M}from"./registry-CyswyZw5.js";import{_ as m}from"./dynamic-tag-CXXozR29.js";import{_ as G}from"./of-fallback-C2gEBeKK.js";import{_ as J,a as K}from"./index-BzmgZE1U.js";import{_ as d}from"./render-tag-CLyPs9qZ.js";import{i as b,r as B,a as I}from"./attr-tag-DphMQldM.js";import{_ as L}from"./empty-component-BCB5DEsP.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-Bq4u441m.js";/* empty css             */class N extends Marko.Component{onCreate(){this.state={selectedIndex:0}}onInput(e){let t=(e.buttons||[]).findIndex(n=>n.selected);t===-1&&(t=0),this.state.selectedIndex=t}onButtonClick(e,t){if(e!==this.state.selectedIndex){this.state.selectedIndex=e;const n=this.input.buttons&&[...this.input.buttons][e].value||void 0;this.emit("change",{index:e,value:n,originalEvent:t})}}}const p="PEDetnqc",l=z(p),U=["large"];q.r(p,()=>l);const O=N;l._=W(function(s,e,t,n,y,A){let{size:o,class:te,buttons:ne,...D}=s;var _=o&&U.includes(o)?o:null;e.be("div",k({class:x(["segmented-buttons",_&&`segmented-buttons--${_}`,s.class])},v(D)),"0",n,null,4),e.be("ul",null,"1",n,null,0);{let R=0;for(const h of G(s.buttons||[])){let u=R++;const a=`[${u}]`,{class:j,icon:f,renderBody:V,...H}=h;e.be("li",null,"2"+a,n,null,0),e.be("button",k({class:x(["segmented-buttons__button",j]),"aria-current":y.selectedIndex===u&&"true"},v(H)),"3"+a,n,null,4,{onclick:t.d("click","onButtonClick",!1,[u])}),f?(e.be("span",{class:"segmented-buttons__button-cell"},"4"+a,n,null,1),m(e,f,null,null,null,null,t,"5"+a),e.be("span",null,"6"+a,n,null,0),m(e,h,null,null,null,null,t,"7"+a),e.ee(),e.ee()):m(e,V,null,null,null,null,t,"8"+a),e.ee(),e.ee()}}e.ee(),e.ee()},{t:p},O);l.Component=M(O,l._);const X=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
