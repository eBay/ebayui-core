import{t as D}from"./index-iqhZMf16.js";import{b as j,a as G}from"./utils-NX-dnf4r.js";import{t as $,r as z,b as B,f as M,p as Z,g as q,i as J,d as E}from"./registry-BhN9Jjhp.js";import{_ as K}from"./dynamic-tag-hjM4Clfs.js";import{_ as L}from"./index-ZOQiR5ti.js";import{_ as I}from"./render-tag-_0PNNh6Y.js";import{_ as N}from"./self-iterator-6yU_KG2T.js";import"./_commonjsHelpers-5-cIlDoe.js";import"./_commonjs-dynamic-modules-h-SxKiO4.js";import"./index-gdhiSckb.js";/* empty css             */const b=["teal","light-teal","green","lime","yellow","orange","magenta"];function P(e,a){if(a)return a;let t=0,o,n;if(e&&e.length>0)for(n=0;n<e.length;n++)o=e.charCodeAt(n),t=(t<<5)-t+o,t|=0;const l=b.length,p=Math.abs(t)%l;return b[p]}const g="hwbmouFG",i=$(g),O=i;z.r(g,()=>i);const A={};i._=B(function(e,a,t,o,n,l){const{a11yText:p,class:F,size:h,color:H,img:y,username:d,renderBody:U,...W}=e;a.be("div",M(Z(W),{role:"img","aria-label":p,class:q(["avatar",F,h&&`avatar--${h}`,`avatar--${P(d,H)}`])}),"0",o,null,4),y?a.e("img",J(y),"1",o,0,4):U?K(a,e,null,null,null,null,t,"2"):d?a.t(d.charAt(0).toUpperCase(),o):I(L,{},a,t,"3"),a.ee()},{t:g,i:!0},A);i.Component=E(A,i._);const Q=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        ebay-avatar
    </span>
