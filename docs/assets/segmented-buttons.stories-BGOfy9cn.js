import{t as L}from"./index-CCz6reEH.js";import{b as X,a as Y}from"./utils-DWCsNc5l.js";import{t as Q,r as W,b as w,e as k,f as x,p as v,d as q}from"./registry-ZV7By7ZP.js";import{_ as d}from"./dynamic-tag-Dub0dLVC.js";import{_ as F,a as G}from"./index-DadBeuaZ.js";import{_ as m}from"./render-tag-Buaq4gMc.js";import{i as b,r as B,a as I}from"./attr-tag-DphMQldM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-Z5IdgrQn.js";/* empty css             */class J extends Marko.Component{onCreate(){this.state={selectedIndex:0}}onInput(e){let t=(e.buttons||[]).findIndex(n=>n.selected);t===-1&&(t=0),this.state.selectedIndex=t}onButtonClick(e,t){e!==this.state.selectedIndex&&(this.state.selectedIndex=e,this.emit("change",{index:e,value:(this.input.buttons[e]||{}).value||void 0,originalEvent:t}))}}const p="LNSA3gQY",l=Q(p),A=l,K=["large"];W.r(p,()=>l);const O=J;l._=w(function(s,e,t,n,y,R){let{size:o,class:ee,buttons:te,...V}=s;var h=o&&K.includes(o)?o:null;e.be("div",k({class:x(["segmented-buttons",h&&`segmented-buttons--${h}`,s.class])},v(V)),"0",n,null,4),e.be("ul",null,"1",n,null,0);{let j=0;for(const _ of s.buttons||[]){let c=j++;const a=`[${c}]`,{class:D,icon:f,renderBody:N,...H}=_;e.be("li",null,"2"+a,n,null,0),e.be("button",k({class:x(["segmented-buttons__button",D]),"aria-current":y.selectedIndex===c&&"true"},v(H)),"3"+a,n,null,4,{onclick:t.d("click","onButtonClick",!1,[c])}),f?(e.be("span",{class:"segmented-buttons__button-cell"},"4"+a,n,null,1),d(e,f,null,null,null,null,t,"5"+a),e.be("span",null,"6"+a,n,null,0),d(e,_,null,null,null,null,t,"7"+a),e.ee(),e.ee()):d(e,N,null,null,null,null,t,"8"+a),e.ee(),e.ee()}}e.ee(),e.ee()},{t:p},O);l.Component=q(O,l._);const P=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
