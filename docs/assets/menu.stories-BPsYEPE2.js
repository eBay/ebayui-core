import{b,a as F}from"./utils-DWCsNc5l.js";import{t as G}from"./index-CCz6reEH.js";import{C as p}from"./index-C1TmvPQk.js";import{r as k,b as f,d as x,t as B}from"./registry-DoALHDDx.js";import{i as w,r as n}from"./attr-tag-DphMQldM.js";import{_ as T}from"./render-tag-BBOJ9dEX.js";import{_ as r}from"./const-element-_KqHYBBN.js";/* empty css             */import"./dynamic-tag-B1GLaPEW.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-BjnxPuxR.js";import"./index-DopldULf.js";import"./index-mP6JM4Am.js";/* empty css             */import"./index-eGtaP7gF.js";import"./index-dh1GPFcN.js";import"./index-Ku187Omj.js";import"./index-D7GlLQHj.js";import"./index-blmbJU0z.js";import"./index-DYoOQ_vw.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";const I=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        ebay-menu
    </span>
...
`,S="QsUVfuH8",d=B(S),Z=r("style",null,1).t(`
    span.sprite-flag {
...
`),ee=r("span",{style:"background-position: 0 -25px",class:"sprite-flag"},0),te=r("span",null,1).t("Austria"),ne=r("span",{style:"background-position: 0 -100px",class:"sprite-flag"},0),ae=r("span",null,1).t("Denmark"),ie=r("span",{style:"background-position: 0 -275px",class:"sprite-flag"},0),re=r("span",null,1).t("Norway");k.r(S,()=>d);const Q={};d._=f(function(i,a,s,t,_,C){a.n(Z,t),T(p,w(()=>{n("items",{renderBody:e=>{e.n(ee,t),e.n(te,t)}}),n("items",{renderBody:e=>{e.n(ne,t),e.n(ae,t)}}),n("items",{renderBody:e=>{e.n(ie,t),e.n(re,t)}})},{text:"Country",...i,items:void 0}),a,s,"1",[["keydown","emit",!1,["keydown"]],["change","emit",!1,["change"]],["select","emit",!1,["select"]]])},{t:S,i:!0},Q);d.Component=x(Q,d._);const se=`<style>
    span.sprite-flag {
        background-image: url('https://ir.ebaystatic.com/pictures/aw/pics/cmp/ds3/sprds3_21.png');
        background-repeat: none;
        display: inline-block;
